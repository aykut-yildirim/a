...
class MynetScraper:
    ...
    def get_link(self, limit: Optional[int] = None):
        """for to add links"""
    ...
    def get_stocks_name(self, link):
        ...
        for elem in child:
            ...
            value_a = elem.find_all("span")[1].text
            dict_item[key_a] = value_a
        share = Stock(name[-5:], name[:-7], self.__create_detail_dataclass(dict_item))
        return share
